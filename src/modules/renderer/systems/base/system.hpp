...
class System : public ISystem {
  ...
  static SystemTypeID system_type_id() {
    return SYSTEM_TYPE_ID;
  }
  ...
  void add_dependencies(Dependencies &&...dependencies) {
    this->m_system_manager->add_system_dependency(this, std::forward<Dependencies>(dependencies)...);
  }

  virtual Either<BaseException, Unit> start() override = 0;
