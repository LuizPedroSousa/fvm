...
namespace astralix {
  ...
  void PropertiesLayer::draw_component(IEntity* entity, const char* icon_name,
    ...
    if (entity->has_component<T>()) {
      ...
      if (ImGui::ImageButton(settings_icon->get_resource_id().c_str(), settings_icon->get_renderer_id(), ImVec2{ line_height, line_height })) {
